...
import com.c.whatsappclonechatapp.databinding.ActivityProfileBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.continueBtn.setOnClickListener {
            when {
                ...
                selectedImg == null -> {
                    Toast.makeText(this@ProfileActivity, "PLease Select Your Image", Toast.LENGTH_SHORT).show()
                }
                else -> uploadData()
            }
        }
    ...
    private fun uploadData() {
        ...
        reference.putFile(selectedImg).addOnCompleteListener {
            if (it.isSuccessful) {
                ...
                Toast.makeText(this@ProfileActivity, "Data Inserted ${it.exception}", Toast.LENGTH_SHORT).show()
            }
        }
    }
